...
class elearning
{
	...
	public function getClasses()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $code . "</td><td>" . $subj . "</td><td>" . $first_name . " " . $last_name . "</td><td>" . $sy . "</td><td><a href='classes_students.php?id=" . $id . "'> View Students</a><a href='classes.php?id=" . $id . "&action=deleteClass' onclick=\"return confirm('Are you sure you want to delete?');\"> Delete</a></td></tr>";
			}
	...
	public function getClassesForStudent()
	{
		try {
			$stmt = $this->DB->prepare("SELECT * FROM tbl_class AS class INNER JOIN tbl_subject AS subj ON class.SUBJECT_ID = subj.SUBJECT_ID INNER JOIN tbl_faculty AS fac ON class.FACULTY_ID = fac.FACULTY_ID INNER JOIN tbl_school_yr AS sy ON class.SCHOOL_YEAR_ID = sy.ID ORDER BY CLASS_ID DESC");
			$stmt->execute();
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $code . "</td><td>" . $subj . "</td><td>" . $first_name . " " . $last_name . "</td><td>" . $sy . "</td><td><a href='student_enroll.php?class=$id&sid=$sid' onclick=\"return confirm('Are you sure you want to enroll?');\">ENROLL</a>";

				// echo "<tr><td>" . $code . "</td><td>" . $subj . "</td><td>" . $first_name . " " . $last_name . "</td><td>" . $sy . "</td><td><a href='enroll.php?id=" . $id . "'> Enroll</a></td></tr>";
			}
	...
	public function getClassesTeacher($userid)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $code . "</td><td>" . $subj . "</td><td>" . $first_name . " " . $last_name . "</td><td>" . $sy . "</td><td><a href='class.php?cid=" . $id . "'> View</a><a href='classes.php?id=" . $id . "&action=deleteClass' onclick=\"return confirm('Are you sure you want to delete?');\"> Delete</a></td></tr>";
			}
		...
		try {
			...
			while ($row1 = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				while ($row = $stmt2->fetch(PDO::FETCH_ASSOC)) {
					...
					$last_name = htmlentities($row['LAST_NAME']);
					$sy = htmlentities($row['SCHOOL_YEAR']);
					echo "<tr><td>" . $code . "</td><td>" . $subj . "</td><td>" . $first_name . " " . $last_name . "</td><td>" . $sy . "</td><td><a href='class.php?cid=" . $id . "'> View</a>";
				}
			}
	...
	public function getStudentsAd()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $sid . "</td><td>" . $first_name . "</td><td>" . $last_name . "</td><td>" . $mobile . "</td><td>" . $dob . "</td><td>" . $course . "</td><td>" . $program . "</td><td><a href='student_edit.php?id=" . $sid . "&action=select-student'>  Edit</a><a href='student.php?id=" . $sid . "&action=deleteStudent' onclick=\"return confirm('Are you sure you want to delete?');\"> Delete</a></td></tr>";
			}
	...
	public function getFacultyAd()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $fid . "</td><td>" . $first_name . "</td><td>" . $last_name . "</td><td><a href='faculty_edit.php?id=" . $fid . "&action=select-faculty'>  Edit</a><a href='faculty.php?id=" . $fid . "&action=deleteFaculty' onclick=\"return confirm('Are you sure you want to delete?');\"> Delete</a></td></tr>";
			}
	...
	public function getSubjectAd()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $scode . "</td><td>" . $title . "</td><td><a href='subject_edit.php?id=" . $id . "&action=select-subject'>  Edit</a><a href='subject.php?id=" . $scode . "&action=deleteSubject' onclick=\"return confirm('Are you sure you want to delete?');\"> Delete</a></td></tr>";
			}
	...
	public function getUsersAd()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $uid . "</td><td>" . $first_name . ' ' . $last_name . "</td><td><a href='users_edit.php?id=" . $uid . "&action=select-user'> Edit</a><a href='users.php?id=" . $uid . "&action=deleteUser' onclick=\"return confirm('Are you sure you want to delete?');\">Delete</a></td></tr>";
			}
	...
	public function getSYAd()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $sy . "</td><td>" . $date . "</td><td><a href='school_year.php?id=" . $id . "&action=activateSY' onclick=\"return confirm('Do you want to change the school year?');\"><img src='../assets/img/check.png'> Activate</a><a href='school_year.php?id=" . $id . "&action=deleteSY' onclick=\"return confirm('Are you sure you want to delete?');\"> Delete</a></td></tr>";
			}
	...
	public function getAnnounceAd()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr>
				<td><a href='announcement_view.php?cid=" . urlencode($cid) . "&id=" . urlencode($id) . "&action=select-announce'>" . htmlspecialchars($title) . "</a></td>
				<td> by " . htmlspecialchars($user) . "</td>
				<td>" . htmlspecialchars($date) . "</td>
				<td>
					<a href='announcement_edit.php?id=" . urlencode($id) . "&action=select-announce'>Edit</a>
					<a href='announcement.php?cid=" . urlencode($cid) . "&id=" . urlencode($id) . "&action=deleteAnnounce' onclick=\"return confirm('Are you sure you want to delete?');\">Delete</a>
				</td>
				</tr>";
			}
	...
	public function getAnnounceTeacherAd($id, $cid)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				<td>
					<a href='announcement_edit.php?id=" . urlencode($id) . "&action=select-announce'>Edit</a>
					<a href='class.php?cid=" . urlencode($cid) . "&id=" . urlencode($id) . "&action=deleteAnnounce' onclick=\"return confirm('Are you sure you want to delete?');\">Delete</a>
				</td>
				</tr>";
}
	...
	public function getAssignmentAd($cid)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $title . "</td><td>" . $desc . "</td><td>" . $file . "</td><td>" . $date . "</td><td><a href='assignments.php?id=" . $id . "&cid=" . $cid . "&action=downloadAss'>Download</a>";
			}
	...
	public function getLatestAnnounce()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $title . "</td><td> by " . $user . "</td><td>" . $date . "</td><td><a href='announcement_view.php?id=" . $id . "&action=select-announce'> View</a>";
			}
	...
	public function getQuizes($id)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td><a href='questions.php?cid=" . $id . "&id=" . $sid . "'>" . $quiz . "</a></td><td>" . $date . "</td><td><a href='quiz_edit.php?id=" . $sid . "&action=select-quiz'>Edit</a><a href='quiz.php?cid=" . $id . "&id=" . $sid . "&action=deleteQuiz' onclick=\"return confirm('Are you sure you want to delete?');\">Delete</a></td></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
	...
	public function getStudentQuizes($id, $user)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $quiz . "</td><td>" . $date . "</td><td><a href='quiz_answer.php?cid=" . $id . "&id=" . $sid . "&action=answer-quiz'>  Take Quiz</a></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
	...
	public function viewQuizes($id)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $quiz . "</td><td>" . $date . "</td><td><a href='grade_students.php?id=" . $sid . "&cid=" . $id . "'> View Scores</a></td></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
	...
	public function getQuestions($cid, $id)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $question . "</td><td>" . $ca . "</td><td>" . $cb . "</td><td>" . $cc . "</td><td>" . $cd . "</td><td>" . $answer . "</td><td><a href='questions_edit.php?id=" . $qid . "&action=select-question'> Edit</a><a href='questions.php?cid=" . $cid . "&id=" . $id . "&qid=" . $qid . "&action=deleteQuestion' onclick=\"return confirm('Are you sure you want to delete?');\"> Delete</a></td></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
	...
	public function getClassStudents($id)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<td>" . $mobile . "</td>";
				echo "<td>" . $course . "</td>";
				echo "<td><a href='students.php?id=" . $id . "&sid=" . $sid . "&action=deleteClassStudent'> Remove</a></td></tr>";

				// echo "<tr><td>" . $sid . "</td><td>" . $fname . " " . $lname . "</td><td>" ."</td><td>" . $course . "</td><td><a href='students.php?id=" . $id . "&sid=" . $sid . "&action=deleteClassStudent'> Remove</a></td></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
	...
	public function getClassStudentsTeacher($id)
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $sid . "</td><td>" . $fname . " " . $lname . "</td><td>" . $mobile . "</td><td>" . $course . "</td><td><a href='classes_students.php?id=" . $id . "&sid=" . $sid . "&action=deleteClassStudent'> Remove</a></td></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
...
WHERE STUDENT_ID NOT IN (SELECT STUDENT_ID FROM tbl_class_student WHERE CLASS_ID = :id);");
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<td>" . $mobile . "</td>";
				echo "<td>" . $course . "</td>";
				echo "<td><a href='classes_students.php?id=" . $id . "&sid=" . $sid . "&action=addToClass'> Add Student</a></td></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
...
WHERE STUDENT_ID NOT IN (SELECT STUDENT_ID FROM tbl_class_student WHERE CLASS_ID = :id);");
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $sid . "</td><td>" . $fname . " " . $lname . "</td><td>" . $course . "</td><td><a href='students.php?id=" . $id . "&sid=" . $sid . "&action=addToClass'> Add Student</a></td></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
	...
	public function enrollStudentToClass($id)
	{
		try {
			$stmt = $this->DB->prepare("SELECT * FROM tbl_class_student AS class_stud INNER JOIN tbl_student AS stud ON class_stud.STUDENT_ID = stud.STUDENT_ID WHERE CLASS_ID = :id ORDER BY `DATE` DESC");
			$stmt->bindValue(':id', $id);
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $sid . "</td><td>" . $fname . " " . $lname . "</td><td>" . $course . "</td><td><a href='students.php?id=" . $id . "&sid=" . $sid . "&action=deleteClassStudent'> Remove</a></td></tr>";
			}
		} catch (Exception $e) {
			echo "Something went wrong!";
		}
